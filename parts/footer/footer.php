<footer itemscope itemtype="http://schema.org/WPFooter">
    <div class="links-container" itemscope itemtype="http://schema.org/WebPage">
        <? use App\LinkPlace; ?>
        <?foreach($links as $k => $l) {
            ...
            ?>
                <div itemscope itemtype="http://schema.org/SiteNavigationElement" class="footer-links-wrapper">
    ...
    <div class="social-media-wrapper" itemscope itemtype="http://schema.org/Organization">

        <meta itemprop="name" content="Таро Гадалка">
        <p class="h3-subtitle-text">Подписывайтесь на нас в социальных сетях:</p>
        <div class="social-logo">
            <a target='blank' itemprop="sameAs" href="https://dzen.ru/gadalka_magic"><i class="fa-brands fa-yandex"></i></a>
            <a target='blank' itemprop="sameAs" href="https://ok.ru/group/70000006796391"><i class="fa-brands fa-square-odnoklassniki"></i></a>
            <a target='blank' itemprop="sameAs" href="https://vk.com/club227014770"><i class="fa-brands fa-vk"></i></a>
            <a target='blank' itemprop="sameAs" href="https://t.me/e21rj3ifreij"><i class="fa-brands fa-telegram"></i></a>
        </div>
