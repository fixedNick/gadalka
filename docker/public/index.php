...
<?
    ...
    <div class="horoscope-section ">
        <div class="horoscope">
            <div class="text-wrapper">
                ...
                <p class="h1-subtitle-tex dark-bg">Выбери свой знак зодиака!</p>
            </div>
    ...
    <?
            for($i=0; $i<12; $i++)
            {
                ...
                <div class="zodiac-sign">
                    <a href="/horoscope/sign?sign=<?=$signs[$i]->name_en?>&on=day">
    ...
    <!-- TODO:
            navigate into the sign types as articles in blog
            or do landing with some funcs and `games` for this types(fire,wind,etc)
    -->
            ...
            foreach ($elements as $key => $element) {
             ...
             <div class="sign-type">
                ...
                <span class="learn-more-btn dark-bg">
                    ...
                    <a href="/love-compatibility" class="text">
                        Узнать больше
                    </a>
                </span>
            </div>    
    ...
    <!-- TODO:
            Get most popular article and put title with short description here.
    -->
    <div class="blog-section">
        <div class="blog-wrapper">
            <h1 class="title-text dark-bg">Планеты-покровители знаков зодиака</h1>
            <p class="h1-subtitle-text dark-bg">У каждого знака Солнца (знака зодиака) есть своя правящая планета или даже две. Они оказывают прямое влияние на личность представителей данного знака, формируя их сильные и слабые стороны.</p>
            <span class="learn-more-btn dark-bg">
                <span class="s-icon">
                    <svg class="star-icon" xmlns="http://www.w3.org/2000/svg" width="10.74" height="13.387" viewBox="0 0 10.74 13.387" fill="currentColor"><path d="M10.608 6.877a8.066 8.066 0 0 1-3.345-1.454c-1-.939-1.519-3.711-1.786-5.281a.172.172 0 0 0-.339 0c-.236 1.61-.756 4.518-1.9 5.508a7.393 7.393 0 0 1-3.1 1.249.171.171 0 0 0 0 .335 7.437 7.437 0 0 1 3.454 1.628c.856.876 1.3 3.033 1.523 4.378a.172.172 0 0 0 .339 0c.207-1.34.622-3.495 1.465-4.373a7.487 7.487 0 0 1 3.689-1.655.171.171 0 0 0 0-.335Z"></path></svg>
                </span>
                <a href="/blog/article?h=46K5" class="text">
                    Узнать больше
                </a>
            </span>
        </div>
