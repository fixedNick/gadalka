...
<head>
    ...
    <link rel="stylesheet" href="/pages/taro/cards.css">
...
<body class="dark">
    ...
    <div class="container">
        <?
        foreach($cards as $idx => $card) {
            echo GetCardHTML($card->ru_name, $card->desc, '/taro/card?cid='.$card->id, $card->id);
        }
        ?>
    </div>
    ...
    <? 
        ...
        echo getPagination($page, $maxOffset, '/taro/cards');
    ?>
