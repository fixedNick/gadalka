...
$_GET['on'] = isset($_GET['on']) && array_filter(['day', 'month', 'year'], function($on) {return $on === $_GET['on'];}) ? $_GET['on'] : 'day';
...
<head>
   ...
   <? 
    ...
    <link rel="stylesheet" href="/pages/horoscope/sign.css">
</head>
<body class="light">
...
?>
        <div class="sign-wrapper" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a itemprop="url" href="/horoscope/sign?sign=<?=$enName?>&on=day">
                <div class="sign">
