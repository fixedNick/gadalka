...
<head>
    ...
    <link rel="stylesheet" href="/pages/horoscope/horoscope.css">

</head>
<body class="light">
    <? require_once($root . '/parts/header/header.php'); ?>
    
    <div class="horoscope-container" itemscope itemtype="http://schema.org/ItemList">
        <div class="horoscope-title">
            <h1 class="title-text" itemprop="name">Твой гороскоп</h1>
        </div>
        ...
        <div class="sections-wrapper">
            <section class="signs">
                ...
                <div class="sign" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <div class="img-wrapper"><img itemprop="image" src="/img/zodiac-signs/<?=$imgPathArr[$_GET['on']]?>/<?=$sign->name_en?>.png" alt="Знак Зодиака <?=$sign->name_ru?>"></div>
                    <div class="sign-desc">
                        <h4 class="title-text" itemprop="name"><?=$sign->name_ru?></h4>
                        <p class="h4-subtitle-text" itemprop="description"><?=$sign->description?></p>
                        <div class="learn-more-btn ">
                            ...
                            <a itemprop="url" href="/horoscope/sign?sign=<?=$sign->name_en?>&on=<?=$_GET['on']?>" class="text">
                                Изучить гороскоп
                            </a>
